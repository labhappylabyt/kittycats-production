...
export function SoundToggle({ inline = false }: { inline?: boolean }) {
  ...
  return (
    <button
      ...
      className={`group flex h-11 items-center gap-2 overflow-hidden rounded-[12px] border border-white/15 bg-[#1b1929] px-3 text-white/70 shadow-[4px_4px_0_rgba(0,0,0,.2)] transition-all duration-300 hover:-translate-y-0.5 hover:border-[#ffd166]/60 hover:text-[#ffd166] ${inline ? '' : 'fixed right-4 top-20 z-50 sm:right-7 sm:top-20'}`}
    >
