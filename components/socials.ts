...
export const socials: Social[] = [
  { name: 'GitHub', handle: '@labhappylabyt', href: 'https://github.com/labhappylabyt', Icon: GitHubIcon, color: '#c4b5fd', ink: INK, status: 'Active', meta: '3 repos · 12 stars' },
  ...
  { name: 'Email', handle: 'lab@kittycats.cc', href: 'mailto:lab@kittycats.cc', Icon: MailIcon, color: '#ffe17d', ink: INK, status: null, meta: null },
]
