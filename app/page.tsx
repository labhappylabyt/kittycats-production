...
export default function HomePage() {
  return (
    <SmoothScroll>
      <main className="relative flex min-h-screen flex-col items-center overflow-hidden px-6 py-16 text-center">
        <PawCursor />
        <SoundToggle />
        ...
        <section
          ...
          aria-label="Lab Deck"
        >
          <h2 className="mb-2 text-2xl font-bold tracking-tight">Lab Deck</h2>
        ...
        {/* Contact */}
        <section
          className="mt-4 flex w-full max-w-3xl flex-col items-center gap-5"
          aria-label="Contact"
        >
